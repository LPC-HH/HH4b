...
def test_combine_years_single_year_passthrough():
    ...
    assert combined is events_dict["2022"]
    assert scaled_by == {}
...
def test_save_event_lists_creates_root_file(tmp_path):
...
def test_save_event_lists_appends_to_existing_root_file(tmp_path):
    uproot = pytest.importorskip("uproot")
    ...
    _save_event_lists(args, events_dict2)
