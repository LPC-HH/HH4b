...
extract_fit_result.py higgsCombineSnapshot.MultiDimFit.mH125.root "w:MultiDimFit" "inject_combined.json" --keep 'CMS_bbbb_hadronic_tf_dataResidual_*'
...
extract_fit_result.py higgsCombineSnapshot.MultiDimFit.mH125.root "w:MultiDimFit" "inject_passvbf.json" --keep 'CMS_bbbb_hadronic_tf_dataResidual_*'
...
extract_fit_result.py higgsCombineSnapshot.MultiDimFit.mH125.root "w:MultiDimFit" "inject_passbin1.json" --keep 'CMS_bbbb_hadronic_tf_dataResidual_*'
...
extract_fit_result.py higgsCombineSnapshot.MultiDimFit.mH125.root "w:MultiDimFit" "inject_passbin2.json" --keep 'CMS_bbbb_hadronic_tf_dataResidual_*'
...
extract_fit_result.py higgsCombineSnapshot.MultiDimFit.mH125.root "w:MultiDimFit" "inject_passbin3.json" --keep 'CMS_bbbb_hadronic_tf_dataResidual_*'
