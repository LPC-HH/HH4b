...
"""
This config is based on v5_glopartv2.py, but with the following changes:
Removed the Tau32, MET, PXbb, PQCD1HF, PQCD2HF, and PQCD0HF variables from the BDT input dataframe
Added the TXbb variable to the BDT input dataframe
    ...
    df_events = pd.DataFrame(
        {
            ...
            # xbb
            # Replacing this info with just the TXbb discriminant
            ...
            key_map("H1Xbb"): events[key_map("bbFatJetParTTXbb")].to_numpy()[:, 0],
            # ratios
