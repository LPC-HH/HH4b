    ...
    df_events = pd.DataFrame(
        {
            ...
            # fatjet mass
            "H2Mass": events["bbFatJetPNetMassLegacy"].to_numpy()[:, 1],
            # fatjet kinematics
            "H1Pt": h1.pt,
            "H2Pt": h2.pt,
            "H1eta": h1.eta,
            # "H2eta": h2.eta,
            # xbb
            "H2Xbb": events["bbFatJetPNetPXbbLegacy"].to_numpy()[:, 1],
            "H2QCDb": events["bbFatJetPNetPQCDbLegacy"].to_numpy()[:, 1],
            "H2QCDbb": events["bbFatJetPNetPQCDbbLegacy"].to_numpy()[:, 1],
            "H2QCDothers": events["bbFatJetPNetPQCDothersLegacy"].to_numpy()[:, 1],
            # ratios
